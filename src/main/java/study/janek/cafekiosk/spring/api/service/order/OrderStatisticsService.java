...
import study.janek.cafekiosk.spring.api.service.mail.MailService;
...
import static study.janek.cafekiosk.spring.domain.order.OrderStatus.PAYMENT_COMPLETED;
...
public class OrderStatisticsService {
    ...
    public boolean sendOrderStatisticsMail(LocalDate orderDate, String email) {
        ...
        boolean result = mailService.sendMail(
            ...
            email, String.format("[매출통계] %s", orderDate),
