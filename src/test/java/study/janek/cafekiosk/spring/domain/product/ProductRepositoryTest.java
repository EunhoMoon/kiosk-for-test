...
class ProductRepositoryTest {
    ...
    void findAllBySellingStatusIn() {
        ...
        Product product3 = createProduct("003", HANDMADE, STOP_SELLING, "팥빙수", 9000);
    ...
    @Test
    @DisplayName("가장 마지막에 저장한 상품의 상품 번호를 받아온다.")
    void findLatestProductNumber() {
        ...
        Product product1 = createProduct("001", HANDMADE, SELLING, "아메리카노", 4000);
        Product product2 = createProduct("002", HANDMADE, HOLD, "카페라뗴", 4500);
        Product product3 = createProduct(targetProductNumber, HANDMADE, STOP_SELLING, "팥빙수", 9000);
    ...
    @Test
    @DisplayName("가장 마지막에 저장한 상품의 상품 번호를 받아올 때 상품이 하나도 없으면 null을 반환한다.")
