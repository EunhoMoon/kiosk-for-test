...
import study.janek.cafekiosk.spring.api.service.order.request.OrderCreateServiceRequest;
...
import static study.janek.cafekiosk.spring.domain.product.ProductType.*;
...
//    }
    ...
    @Test
    @DisplayName("재고와 관련된 상품이 포함된 상품번호 리스트로 주문을 생성할 수 있다.")
    ...
    @Test
    @DisplayName("재고가 부족한 상품을 주문할 경우 예외 발생")
    void createOrderWithStockOver() {
        //given
        LocalDateTime registeredDateTime = LocalDateTime.now();
